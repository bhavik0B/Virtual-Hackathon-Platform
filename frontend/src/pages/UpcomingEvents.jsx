...
const UpcomingEvents = () => {
    ...
    const filteredHackathons = hackathons.filter(hackathon => {
        ...
        const isUpcomingOrActive = hackathon.status === 'upcoming' || hackathon.status === 'active';

        return matchesSearch && matchesStatus && matchesEligibility && isUpcomingOrActive;
    });
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 mt-1">Discover and join exciting hackathons</p>
                        </div>
                    </div>
                ...
                {sortedHackathons.length === 0 ? (
                    <div className="text-center py-20">
                        ...
                        <h3 className="text-xl font-semibold text-gray-400 mb-2">No upcoming events found</h3>
                            ...
                            >
                                <Card className="p-6 h-full hover:shadow-xl transition-all duration-300 hover:border-blue-500/30">
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-slate-700">
                                        ...
                                        <Button
                                            size="sm"
                                            onClick={() => navigate('/join-hackathon', { state: { hackathon } })}
                                            className="flex items-center space-x-2"
                                        >
